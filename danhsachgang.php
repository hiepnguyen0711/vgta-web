...
<div class="container content">
  ...
  <div class="col-md-8 left">
  	<div class="breadcum">
    	<img src="images/icon-title-tintuc.png" id="logotitle" /> <p><a href="trangchu">TRANG CHỦ </a> <i class="fa fa-angle-double-right"></i> <a href="danhsachgang.php">Danh sách Gangs VGTA SAMP</a> </p>
    ...
    <div class="col-md-12 noidung gang">
    	<table width="100%" border="1" cellpadding="5" cellspacing="5">
            ...
            <tbody>
            	<?php 
					$qr =  "SELECT f.ID 'id',f.hinhgang 'h', COUNT(f.ID)'a' , SUM(a.XepHang) 'b', f.Leader 'l', f.Name 'n' FROM `families` f JOIN `accounts` a ON (f.ID = a.FMember) GROUP BY f.ID ORDER BY SUM(a.XepHang) DESC";
					$resultgangs = mysqli_query($connect,$qr);
					while($row = mysqli_fetch_array($resultgangs)){
					
				?>
            	<tr>
                	<td>F<?php echo $row['id']?></td>
                    <td><img src="hinhgangs/<?php echo $row['h']?>" width="50px" height="50px" /></td>
                   ...
                   <!-- lấy thông tin gangs ( thành viên và điểm rank )-->
                    ...
                    <td><?php echo adddotstring($row['b']) ?></td>
