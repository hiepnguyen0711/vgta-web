...
<link rel="stylesheet" type="text/css" href="css/styledanhsachgang.css"/>
<!-- InstanceEndEditable -->
</head>
...
<div class="container content">
  ...
  <div class="col-md-12 left">
  	<div class="breadcum">
    	<img src="images/icon-title-tintuc.png" id="logotitle" /> <p><a href="trangchu">TRANG CHỦ </a> <i class="fa fa-angle-double-right"></i> <a href="danhsachgang.php">Check POT</a> </p>
    
    </div>
    <div class="clear"></div>
    <div class="col-md-12 noidung gang">
    	<table width="100%" border="1" cellpadding="5" cellspacing="5">
        	<thead>
            	<tr>
                    ...
                    <th>Tên</th>
                    <th>Level</th>
                    <th>Tiền Trong House</th>
                    <th>Pot Trong House</th>
                    <th>Crack Trong House</th>
                    <th>Vật Liệu Trong House</th>
                    <th>Tổng Vật Liệu Đang có</th>
                    
                </tr>
            </thead>
            <tbody>
            	<?php 
					$qr =  "SELECT a.id 'id', a.IP 'IP', a.Username 'Username', a.Level 'Level', h.SafeMoney 'Money', h.Pot 'Pot', h.Crack 'Crack', h.Materials 'Materials', a.Materials + h.Materials 'Tong'  FROM `houses` h JOIN `accounts` a ON h.OwnerID = a.id order by h.Materials desc limit 0,100";
					$resultgangs = mysqli_query($connect,$qr);
					while($row = mysqli_fetch_array($resultgangs)){
            	...
            	<tr>
                    ...
                    <td><?php echo adddotstring($row['Money'])?></td>
                   
                     <td><?php echo adddotstring($row['Pot'])?></td>
                     <td><?php echo adddotstring($row['Crack'])?></td>
                    <td><?php echo adddotstring($row['Materials'])?></td>
                    
                       <td><?php echo adddotstring($row['Tong'])?></td>
                    
             
                   <!-- lấy thông tin gangs ( thành viên và điểm rank )-->
                ...
                <!--<tr>
                	<td>F2</td>
                    <td><img src="admincp/uploads/images.jpg" width="50px" height="50px" /></td>
                    <td>Yakuza</td>
                    <td>Skyspy</td>
                    <td>25</td>
                    <td>3.321</td>
                    <td><a href="#">Xin Vào</a></td>
                </tr>
                <tr>
                	<td>F3</td>
                    <td><img src="admincp/uploads/images.jpg" width="50px" height="50px" /></td>
